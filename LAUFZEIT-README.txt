PARTY PLAYER - PORTABLE WINDOWS-VERSION

Start:
  PartyPlayer.exe doppelt anklicken.

Installation auf einem anderen Rechner:
  Den gesamten Ordner PartyPlayer kopieren. Einzelne Dateien aus dem Ordner
  duerfen nicht entfernt oder verschoben werden.

Voraussetzungen:
  Windows 10 oder Windows 11, 64 Bit.
  VLC/libVLC muss fuer die Wiedergabe separat installiert sein. PartyPlayer
  ...
  PartyPlayer liefert VLC, libVLC, VLC-Plugins, FFmpeg und FFprobe nicht mit und
